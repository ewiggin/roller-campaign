...
describe('GuestsService', () => {
  ...
  it('getAll makes GET /api/guests with no params', () => {
    ...
    http
      .expectOne((r) => r.url === '/api/guests' && r.method === 'GET')
  ...
  it('generateToken makes GET /api/guests/:id/token', () => {
    ...
    http
      .expectOne((r) => r.url === '/api/guests/g1/token' && r.method === 'GET')
      .flush({ token: 't', access_url: 'u' });
  });
  ...
  it('parseImport passes regionId in query string', () => {
    ...
    http
      .expectOne((r) => r.url === '/api/guests/import/parse?regionId=r1')
      .flush({
        valid: [],
        errors: [],
        duplicates: [],
