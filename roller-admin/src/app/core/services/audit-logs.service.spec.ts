...
describe('AuditLogsService', () => {
  ...
  it('getAll makes GET /api/audit-logs', () => {
    ...
    http
      .expectOne((r) => r.url === '/api/audit-logs' && r.method === 'GET')
  ...
  it('getAll passes resource param', () => {
    ...
    const req = http.expectOne(
      (r) => r.url === '/api/audit-logs' && r.params.get('resource') === 'guest',
    );
  ...
  it('getAll passes action param', () => {
    ...
    const req = http.expectOne(
      (r) => r.url === '/api/audit-logs' && r.params.get('action') === 'create',
    );
    req.flush({ data: [], total: 0, page: 1, limit: 20 });
  });
  ...
  it('getAll passes actor_email param', () => {
    ...
    const req = http.expectOne(
      (r) => r.url === '/api/audit-logs' && r.params.get('actor_email') === 'admin@test.com',
    );
    req.flush({ data: [], total: 0, page: 1, limit: 20 });
  });
