...
export interface CampaignLimits {
  ...
  maxGuestGroupsPerPreachingGroup: number;
}
...
export class SettingsService {
  ...
  async updateCampaignSettings(
    ...
    if (dto.max_guest_groups_per_preaching_group !== undefined)
      row.max_guest_groups_per_preaching_group =
        dto.max_guest_groups_per_preaching_group;
  ...
  async getCampaignLimits(): Promise<CampaignLimits> {
    ...
    return {
      ...
      maxGuestGroupsPerPreachingGroup: row.max_guest_groups_per_preaching_group,
    };
  }
