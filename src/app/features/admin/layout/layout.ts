...
const ICONS = {
  ...
  cart: [
    'M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.25m-11.25 0 1.5-7.5h14.25m-14.25 0H7.5',
    'M15.75 17.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm-8.25 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z',
  ],
  settings: [
...
export class AdminLayoutComponent implements OnInit {
  ...
  private readonly ALL_NAV_ITEMS: NavItem[] = [
    ...
    { label: 'Carts', path: '/admin/carts', screen: 'carts', paths: ICONS.cart },
    { label: 'Activities', path: '/admin/activities', screen: 'activities', paths: ICONS.calendar },
    {
      label: 'Preaching Shifts',
      path: '/admin/preaching-shifts',
      screen: 'activities',
  ...
  protected readonly adminNavItems: NavItem[] = [
    { label: 'Users', path: '/admin/users', paths: ICONS.shield },
